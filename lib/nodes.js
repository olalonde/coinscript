...
function new_context() {
  ...
  var definitions = {
    ...
    hash256:  [ 'OP_HASH256',  2, true ],
    sha256:   [ 'OP_SHA256',   2, true ],
...
Root.prototype.compileNode = function (o) {
  ...
  var mainInvocation = new Invocation('main', [ new StackValue(0), new StackValue(1) ]);
...
Func.prototype.compileBody = function (o) {
  ...
  this.params.forEach(function (param, i) {
    o.vars[param.name] = new StackValue(o.stack.length - 1 - i);
  });
...
Invocation.prototype.compileNode = function (o) {
  ...
  // 3. Variable: if not compiled, compile. After compilation, keep track
  //    of position on stack.If compiled previously,
  //    try to copy its value on stock to top of stack.
  //
  // TODO: Optimize!
